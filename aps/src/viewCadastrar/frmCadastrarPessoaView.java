...
public class frmCadastrarPessoaView extends JFrame {
	...
	public frmCadastrarPessoaView(Login login) {
		...
		labelImagem.setIcon(new ImageIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/imagem1.jpg")).getImage().getScaledInstance(534,555,Image.SCALE_SMOOTH)));
