...
public class frmCadastrarPatrimonioView extends JFrame {
	...
	public frmCadastrarPatrimonioView(Login login) {
		...
		labelImagem.setIcon(new ImageIcon(frmCadastrarPatrimonioView.class.getResource("/imagens/imagem1.jpg")));
		labelImagem.setIcon(new ImageIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/imagem1.jpg")).getImage().getScaledInstance(434,561,Image.SCALE_SMOOTH)));
		labelImagem.setBounds(0, 0, 434, 561);
