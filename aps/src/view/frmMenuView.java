...
public class frmMenuView extends JFrame {
	...
	public frmMenuView(Login login) {
		...
		labelImagem.setIcon(new ImageIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/imagem1.jpg")).getImage().getScaledInstance(434,363,Image.SCALE_SMOOTH)));
