...
public class frmGerenciadorChamadosView extends JFrame {
	...
	public frmGerenciadorChamadosView(Login login) {
		...
		labelImagem.setIcon(new ImageIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Destaque-Guia-Help-Desk.png")).getImage().getScaledInstance(670,667,Image.SCALE_SMOOTH)));

		labelImagem.setBounds(0, -26, 670, 667);
